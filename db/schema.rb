...
ActiveRecord::Schema.define(version: 20171223072232) do
  ...
  create_table "favnotifications", force: :cascade do |t|
    t.boolean "read", default: false
    t.bigint "user_id"
    t.bigint "questionnaire_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["questionnaire_id"], name: "index_favnotifications_on_questionnaire_id"
    t.index ["user_id"], name: "index_favnotifications_on_user_id"
  end
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["questionnaire_id", "user_id"], name: "index_favorites_on_questionnaire_id_and_user_id", unique: true
    t.index ["questionnaire_id"], name: "index_favorites_on_questionnaire_id"
  ...
  add_foreign_key "favnotifications", "questionnaires"
  add_foreign_key "favnotifications", "users"
  add_foreign_key "favorites", "questionnaires"
